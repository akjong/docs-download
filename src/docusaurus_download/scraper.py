"""Core scraper module for Docusaurus documentation sites."""
...
@dataclass
class ScraperConfig:
    """Configuration for the Docusaurus scraper."""
...
class DocusaurusScraper:
    ...
    async def run(self) -> ScraperStats:
        """Run the scraper."""
        console.print("[bold blue]Docusaurus Scraper[/bold blue]")
        ...
        async with async_playwright() as p:
            ...
            async with httpx.AsyncClient(
                ...
                # Filter URLs to those under base_path
